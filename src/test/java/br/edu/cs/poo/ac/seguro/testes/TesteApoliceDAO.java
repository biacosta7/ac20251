...
import br.edu.cs.poo.ac.seguro.testes.ApoliceDAO;
...
public class TesteApoliceDAO extends TesteDAO{
    ...
    public void teste01() {
        ...
        cadastro.incluir(new Apolice(ve, new BigDecimal("19.99"), null, null), numero);
    ...
    public void teste02() {
        ...
        cadastro.incluir((Serializable)new Apolice(ve, new BigDecimal("19.99"), null, null), numero);
    ...
    public void teste05() {
        ...
        Apolice novaApolice = new Apolice(ve, new BigDecimal("19.99"), null, null);
    ...
    public void teste06() {
        ...
        Apolice apolice = new Apolice(ve, new BigDecimal("19.99"), null, null);
    ...
    public void teste07() {
        ...
        boolean ret = dao.alterar(new Apolice(ve, new BigDecimal("19.99"), null, null));
        Assertions.assertFalse(ret);
        Apolice apolice = dao.buscar(numero);
        Assertions.assertNull(apolice);
    }
    ...
    public void teste08() {
        ...
        Apolice apolice = new Apolice(ve, new BigDecimal("19.99"), null, null);
        cadastro.incluir((Serializable)apolice, numero);
        apolice = new Apolice(ve, new BigDecimal("19.90"), null, null);
        apolice.setNumero(numero);
